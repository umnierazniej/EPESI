...
class Utils_RecordBrowser extends Module {
    ...
    private $disabled = array('search'=>false, 'browse_mode'=>false, 'watchdog'=>false, 'quickjump'=>false, 'filters'=>true, 'headline'=>false, 'actions'=>false, 'fav'=>false, 'pdf'=>false, 'export'=>false, 'pagination'=>false);
    private $force_order;
...
//                  $gb->set_module_variable('quickjump_to',null);
        ...
        if (!$pdf && !$special && $this->get_access('add',$this->custom_defaults)!==false) {
            ...
            if ($label!==false && $label!=='') Base_ActionBarCommon::add('plus-square',__('Add new'), $label, __('Add new record'));
        }
