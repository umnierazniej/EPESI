...
class CRM_Filters extends Module {
	...
	public function body() {
		...
		eval_js('jQuery(\'#crm_filters_my\').on(\'click\', crm_filters_deactivate)');
		...
		eval_js('jQuery(\'#crm_filters_manage\').on(\'click\', crm_filters_deactivate)');
		...
		while($row = $ret->FetchRow()) {
			...
			eval_js('jQuery(\'#crm_filters_'.$row['id'].'\').on(\'click\', crm_filters_deactivate)');
		}
